...
export const useAttendanceStore = defineStore('attendance', {
  ...
  getters: {
    ...
    statusOptions: () => [
      ...
      { text: 'Late', value: 'late', color: 'warning' },
      { text: 'Half Day', value: 'half_day', color: 'info' }
    ]
  },
  ...
  actions: {
    ...
    async loadClassAttendance(className, section, date = null) {
      this.isLoading = true
      try {
    ...
    async loadMonthlyReport(month, className = null) {
      this.isLoading = true
      try {
        const response = await attendanceService.getMonthlyReport(month, className)
